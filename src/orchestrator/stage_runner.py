        ...
        if self.stage_name in {
            ...
            if "claim-owned visual Evidence" in reason:
                message += (
                    ...
                    "Copy pixel Evidence IDs exactly from the feedback; do not "
                    "shorten or alter any character. Normal web/source Evidence "
                    "does not need to be listed in "
                    "visual_evidence_disposition; if you listed it there, it "
                    "will be ignored for pixel-consumption bookkeeping. Do not "
                    "dispose of Evidence for the same claim. If validator "
                    "feedback says supported/refuted "
