"""Shared post-hoc metrics for private-gold candidate audits.

The same classification must be used for Agent and direct-QA outputs.  This
module deliberately does not inspect runtime-specific evidence fields such as
``evidence_chain_recovery``; the frozen private-gold judge is the authority for
both label correctness and evidence quality.
"""
