"""Immutable review-policy candidate; never edit the frozen Agent or live v14."""
import hashlib
import json
import os
...
OLD = ROOT / 'training-artifacts/psd-observed-positions-20260916-v14/code'
CODE = DEPLOY / 'code'
OVERLAYS = {
...
def main():
    ...
    state = {'tests_returncode': result, 'frozen_agent_unchanged': True, 'provider_calls': 0,
             'training_started': False, 'deployment_ready_not_live': result == 0,
             'review_policy': 'grounded-procedural-advice-v3'}
