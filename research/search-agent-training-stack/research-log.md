...
| 5 | 2026-07-22 | reward-audit | Inspected released reward code in Search-R1, ReCall/ReSearch, DeepResearcher, rLLM, WebAgent-R1, R-Search, and DEFAME/AVeriTeC. Most systems use terminal outcome reward. R-Search's selected-Evidence verifier is the closest reusable pattern. Revised IFV direction to outcome + selected-basis recoverability + strict/fatal gates; deferred subjective per-step shaping. |
